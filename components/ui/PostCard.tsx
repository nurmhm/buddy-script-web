...
const PostCard = ({ post }: PostCardProps) => {
  ...
  src={`${process.env.NEXT_PUBLIC_IMAGE_BASEURL}${post.imageUrl}`}
  alt="Post"
            ...
            <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
              <div className="_feed_inner_timeline_total_reacts_image">
                ...
                <img
                  ...
                  className="_react_img _rect_img_mbl_none"
                />
                <p className="_feed_inner_timeline_total_reacts_para">{post?.likeCount || 0}</p>
              </div>
              <div className="_feed_inner_timeline_total_reacts_txt">
                <p className="_feed_inner_timeline_total_reacts_para1">
                  <span>{post.commentCount || 0}</span> Comment
                </p>
            ...
            <div className="_feed_inner_timeline_reaction">
              ...
              <button className="_feed_inner_timeline_reaction_comment _feed_reaction" onClick={toggleComments}>
                <span className="_feed_inner_timeline_reaction_link">
                  {" "}
                  <span>
                    <svg
                ...
                {displayedComments.map((comment) => (
                  <div className="_comment_main" key={comment.id}>
                    ...
                    <div className="_comment_area">
                        ...
                        <div className="_comment_reply">
                          <div className="_comment_reply_num">
                            <ul className="_comment_reply_list">
                              ...
                              <li>
                                <span className="_time_link">{formatDistanceToNow(new Date(comment.createdAt), { addSuffix: true })}</span>
                              </li>
                            </ul>
                          </div>
                        </div>
                          ...
                          <div className="_feed_inner_comment_box_content">
                            ...
                            <div className="_feed_inner_comment_box_content_txt">
                              <textarea
                                className="form-control _comment_textarea"
                                placeholder="Write a comment"
                                id={`floatingTextarea2-${comment.id}`}
                                value={replyText[comment.id] || ""}
                                onChange={(e) => setReplyText((prev) => ({ ...prev, [comment.id]: e.target.value }))}
                                onKeyDown={(e) => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); handleSubmitReply(e, comment.id); } }}
                              ></textarea>
                            </div>
                          </div>
                          <div className="_feed_inner_comment_box_icon">
                      ...
                      {expandedReplies.has(comment.id) && <Replies commentId={comment.id} />}
                    </div>
                  </div>
                ))}
              </div>
